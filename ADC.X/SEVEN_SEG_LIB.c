...
/*
    SEGA = (deeco_ac_values[num]&1  != 0 ?1:0;
    SEGB = (deeco_ac_values[num]&2  != 0 ?1:0;
    SEGC = (deeco_ac_values[num]&4  != 0 ?1:0;
    SEGD = (deeco_ac_values[num]&8  != 0 ?1:0;
    SEGE = (deeco_ac_values[num]&16 != 0 ?1:0;
    SEGF = (deeco_ac_values[num]&32 != 0 ?1:0;
    SEGG = (deeco_ac_values[num]&64) != 0 ?1:0;
    */
}
